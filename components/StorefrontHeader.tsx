    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <nav className="flex items-center gap-4">
          <Link
            href="/sepet"
            className="relative inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"
          >
            🛒 Sepet
            {cartCount > 0 && (
          ...
          <Link
            href="/admin"
            className="hidden rounded-lg px-3 py-2 text-sm text-slate-500 hover:text-slate-800 sm:inline"
          >
            Yönetim
          </Link>
        </nav>
